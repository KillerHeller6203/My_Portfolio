export const experiences = [
  {
    ...
    type: "Mentoria",
    company: "Owned platform infrastructure and delivery pipeline for a production job-search platform. Diagnosed and fixed a silent Celery Beat scheduler outage, redesigned task queue routing to prevent silent task loss, resolved a Redis memory-eviction issue affecting distributed locks and cooldown state, and stood up CI/CD (GitHub Actions) and a staging environment from zero. Fixed a database connection-lifecycle bug that was blocking horizontal scaling, and rebuilt delivery-pipeline observability (deploy verification, scheduler heartbeat checks) across a multi-service Render deployment.",
    description:
